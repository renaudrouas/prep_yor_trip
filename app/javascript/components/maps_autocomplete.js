      ...
      document.getElementById('accomodation_phone_number').value = place.formatted_phone_number
          ...
          // document.getElementById('accomodation_kind').value = place.marker
          // 2. fill form address input #id_of_the_input with address
          // Document.getElementById('id_of_the_input').value = address
          // 3. fill form name input #id_of_the_input with place.name
          // Document.getElementById('id_of_the_input').value = place.name
